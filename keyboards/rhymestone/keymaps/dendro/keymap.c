...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
          KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,    KC_UP,     KC_L,
  //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
          KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,  KC_LEFT,  KC_DOWN,  KC_RGHT,
  //`---------+---------+---------+---------+---------+---------+---------+---------+---------+---------'
       KC_LCTL,    KC_TAB,  KC_LALT,    LOWER,  KC_SPC,   KC_RSFT,   RAISE,  KC_BSPC,   KC_ENT,  KC_RGUI
  //,---------------------------------------------------------------------------------------------------.
  ),

  [_LOWER] = LAYOUT( \
  //,---------------------------------------------------------------------------------------------------.
          KC_7,     KC_8,     KC_9,     KC_0,  XXXXXXX,  XXXXXXX,  KC_LBRC,  KC_RBRC,  KC_MINS,   KC_EQL,
  //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
          KC_4,     KC_5,     KC_6,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_GRV,   KC_SCLN,  KC_QUOT,  KC_BSLS,
  //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
          KC_1,     KC_2,     KC_3,  XXXXXXX,  XXXXXXX,   KC_DEL,  XXXXXXX,  KC_COMM,   KC_DOT,  KC_SLSH,
  //`---------+---------+---------+---------+---------+---------+---------+---------+---------+---------'
  ...
  //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
         KC_F5,    KC_F6,    KC_F7,    KC_F8,   KC_DEL,  KC_PGUP,  XXXXXXX,  KC_HOME,  _______,   KC_END,
  //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
         KC_F1,    KC_F2,    KC_F3,    KC_F4,   KC_INS,  KC_PGDN,  XXXXXXX, CTL_LEFT,  _______, CTL_RGHT,
  //`---------+---------+---------+---------+---------+---------+---------+---------+---------+---------'
