...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_NUMPAD] = {
    ...
    {KC_LSFT, KC_LALT,    KC_0,    KC_LSFT, KC_LCTL, _______, _______,  KC_SPC,   NUMPAD,   KC_PSCR,  KC_SLCK,  KC_PAUS}
  },
  ...
  [_LOWER] = {
    ...
    {KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_DEL,  KC_SCLN, KC_QUOT, KC_LBRC, KC_RBRC, KC_BSLS},
    {KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_NUHS, KC_NUBS, KC_COMM, KC_DOT, KC_SLSH},
    {KC_LSFT, KC_LALT, KC_LGUI, KC_LSFT, KC_LCTL, _______, _______, KC_SPC, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
  },
