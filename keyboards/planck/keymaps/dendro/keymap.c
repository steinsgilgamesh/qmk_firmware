...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_NUMPAD] = {
    {_______, _______,    KC_7,    KC_8,    KC_9,    KC_ESC,  KC_GRV,   _______,  _______,  KC_7,     KC_8,     KC_9},
    {_______, _______,    KC_4,    KC_5,    KC_6,    KC_TAB,  KC_BSPC,  _______,  _______,  KC_4,     KC_5,     KC_6},
    {_______, _______,    KC_1,    KC_2,    KC_3,    KC_CAPS, KC_RGUI,  _______,  _______,  KC_1,     KC_2,     KC_3},
    {KC_LSFT, KC_LALT,    KC_0,    KC_LSFT, KC_LCTL, _______, _______,  KC_SPC,   NUMPAD,   KC_PAUS,  _______,  KC_0}
  },
  ...
  */
  ...
  [_RAISE] = {
    {KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_F7,    KC_F8,    KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN,   KC_RPRN},
    {_______, KC_PIPE, KC_LCBR, KC_RCBR, _______, KC_F9,    KC_F10,   _______,  KC_LT,    KC_GT,    KC_QUES,   KC_BSPC},
    {_______, _______, KC_COLN, KC_DQT,  _______, KC_F11,   KC_F12,   _______,  KC_UNDS,  KC_PLUS,  KC_VOLU,   KC_MPLY },
   ...
   */
  [_LOWER] = {
    {KC_1,    KC_2,     KC_3,    KC_4,    KC_5,     KC_F1,    KC_F2,    KC_6,     KC_7,    KC_8,    KC_9,     KC_0},
    {KC_TAB,  KC_BSLS,  KC_LBRC, KC_RBRC, _______,  KC_F3,    KC_F4,    _______,  KC_COMM, KC_DOT,  KC_SLSH,  KC_DEL},
    {_______, _______,  KC_SCLN, KC_QUOT, _______,  KC_F5,    KC_F6,    _______,  KC_MINS, KC_EQL,  KC_PGUP,  KC_INS},
