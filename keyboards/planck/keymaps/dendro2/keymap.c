...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = {
    ...
    {KC_LSFT, KC_LALT, KC_LGUI, KC_LSFT, KC_LCTL, LOWER,   RAISE,   KC_SPC,  KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT}
  },
  ...
  */
  ...
  [_NUMPAD] = {
    ...
    {KC_LSFT, KC_LALT,    KC_LGUI, KC_0,    KC_LCTL, _______, _______,  KC_SPC,   KC_RGUI,  _______,  KC_PGDN,  _______}
  },
*/
  ...
  */
  ...
  [_RAISE] = {
    ...
    {KC_LSFT, KC_LALT, KC_LGUI, KC_LSFT, KC_LCTL, _______,  _______,  KC_SPC,   KC_RGUI,  KC_MPRV,  KC_MPLY,  KC_MNXT}
  },
  ...
  */
  ...
  [_LOWER] = {
    ...
    {KC_LSFT, KC_LALT,  KC_LGUI, KC_LSFT, KC_LCTL,  _______,  _______,  KC_SPC,   KC_RGUI,  KC_PSCR,  KC_SLCK, KC_PAUS}
  },
  ...
  [_ADJUST] = {
    ...
    {_______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  TERM_ON, TERM_OFF, _______, KC_PGUP, _______},
    {BACKLIT, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGDN, _______}
  }
