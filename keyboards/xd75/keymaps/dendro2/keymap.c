...
Missing still...  
  ...
  */  
   [_QWERTY] = { /* QWERTY, with keypad in the centre */
     { KC_1,     KC_2,    KC_3,      KC_4,      KC_5,     KC_ESC,   KC_GRV,    KC_6,    KC_7,     KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,    KC_DEL },
     { KC_Q,     KC_W,    KC_E,      KC_R,      KC_T,     KC_CAPS,  KC_PGUP,   KC_Y,    KC_U,     KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,   KC_BSLS },
     { KC_A,     KC_S,    KC_D,      KC_F,      KC_G,     KC_TAB,   KC_BSPC,   KC_H,    KC_J,     KC_K,    KC_L,    KC_ENTER,KC_SCLN, KC_QUOT,   KC_GRV },
     { KC_Z,     KC_X,    KC_C,      KC_V,      KC_B,     KC_RSFT , KC_RGUI,   KC_N,    KC_M,     KC_HOME, KC_UP,   KC_END,  KC_COMM, KC_DOT,    KC_SLSH },
     { KC_LSFT,  KC_LALT, KC_LGUI,   FUNCTION,  KC_LCTL,  KC_LSFT,  MLOWER,    KC_SPC,  MRAISE,   KC_LEFT, KC_DOWN, KC_RGHT, KC_MNXT, KC_MPRV,   KC_RSFT }
   },
 ...
 */
 ...
 [_RAISE] = { /* RAISED */
  { KC_F1,     KC_F2,    KC_F3,   KC_F4,   KC_F5,   BL_TOGG,  _______,  KC_F6,    KC_F7,   KC_F8, KC_F9,  KC_F10, KC_F11, KC_F12, RGB_TOG },
  { BL_ON,    _______,   _______,  _______, _______, _______, _______,  _______,  _______, KC_7,  KC_8,   KC_9,    _______, _______, RGB_MOD  },
  { BL_OFF,   _______,   _______,  _______, _______, _______, _______,  _______,  _______, KC_4,  KC_5,   KC_6, _______, ___T___, ___T___ },
  { BL_INC,   _______,   _______,  _______, _______, _______, _______,  _______,  _______, KC_1,  KC_2,   KC_3, ___T___, _______, _______  },
  { BL_DEC,   _______,   _______,  _______, _______, _______, _______,  _______,  _______, _______, _______, KC_0,  _______, _______, _______  },
 },
