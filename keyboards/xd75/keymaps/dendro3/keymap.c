...
Missing still...  
  ...
  */  
   [_QWERTY] = { /* QWERTY, with keypad in the centre */
     { _______, KC_1,     KC_2,    KC_3,      KC_4,    KC_5,    KC_INS,   KC_ESC,   KC_DEL,   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     _______ },
     { KC_CAPS, KC_Q,     KC_W,    KC_E,      KC_R,    KC_T,    KC_TAB,   KC_PGUP,  _______,  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_BSPC },
     { KC_TAB,  KC_A,     KC_S,    KC_D,      KC_F,    KC_G,    KC_EQL,   KC_PGDN,  KC_MINS,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_ENTER },
     { KC_LSFT, KC_Z,     KC_X,    KC_C,      KC_V,    KC_B,    KC_BSLS,  KC_GRV,   KC_QUOT,  KC_N,    KC_M,    KC_SLSH, KC_HOME, KC_UP,    KC_END },
     { KC_LSFT, KC_LALT,  KC_LGUI, KC_LBRC,   KC_RBRC, KC_LCTL, MLOWER,   KC_RSFT,  MRAISE,   KC_SPC,  KC_COMM, KC_DOT,  KC_LEFT, KC_DOWN,  KC_RGHT }
   },
 ...
 */
 ...
 [_ADJUST] = { /* FUNCTION */
  ...
  { RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, BL_TOGG, BL_INC,  BL_DEC,   BL_ON, BL_OFF, KC_MS_U, KC_WH_D  },
