...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_LALT, KC_LALT, MFUNC,   KC_LCTL, SYMBOL,  KC_LGUI, KC_RSFT, KC_SPC,  KC_RGUI, MFUNC,   KC_RALT, KC_RCTL, KC_RGUI \
  ),
  ...
  [_SYMBOL] = LAYOUT( \
    ...
    KC_LCTL, KC_LALT, KC_LALT, _____,   KC_LCTL, _____,   KC_LGUI, KC_RSFT, KC_SPC,  KC_RGUI, _____,   KC_RALT, KC_RCTL, KC_RGUI \
  ),
