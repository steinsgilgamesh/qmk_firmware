...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP_2_SHIFTS(
		...
		KC_LCTL,  KC_LGUI,  KC_LALT,  KC_BSPC,  MO(1),    KC_SPC, KC_RCTL,  MO(2),  KC_LEFT,  KC_DOWN,  KC_RGHT),
	...
	KEYMAP_2_SHIFTS(
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, BL_DEC, BL_TOGG, BL_INC, BL_STEP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_TRNS, 
