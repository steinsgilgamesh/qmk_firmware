...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_BSPC,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,   KC_N,     KC_M,   KC_COMM,  KC_DOT,   KC_SLSH,  KC_HOME, KC_UP,   KC_END,
		KC_LCTL,  KC_LGUI,  KC_LALT,  KC_LSFT,  MO(1),    KC_SPC, KC_RALT,  MO(2),  KC_LEFT,  KC_DOWN,  KC_RGHT),
